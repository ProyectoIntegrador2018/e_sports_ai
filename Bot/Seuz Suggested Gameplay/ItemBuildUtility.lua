...
-- This function will select the next talen to be taken based on zeus abilities and overall game status
...
-- This function will select the next skill to be taken based on zeus abilities and overall game status
...
-- This function will return the used slots pattern
...
-- This function will decide the item buy pattern (slots to be filled) 
